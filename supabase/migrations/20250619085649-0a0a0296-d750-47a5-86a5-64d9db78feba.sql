-- Add actual_arrival_time field to track when truck was actually marked as arrived
ALTER TABLE public.trucks ADD COLUMN actual_arrival_time TIME WITH TIME ZONE;

-- Update handle_truck_arrival function to also set actual arrival time
